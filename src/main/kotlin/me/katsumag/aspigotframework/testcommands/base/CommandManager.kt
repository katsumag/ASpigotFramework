...
import me.katsumag.aspigotframework.testcommands.annotations.Alias
...
class CommandManager @JvmOverloads constructor(// The plugin's main class
    ...
    fun register(command: CommandBase) {
        ...
        if (!commandClass.isAnnotationPresent(me.katsumag.aspigotframework.testcommands.annotations.Command::class.java)) {
            throw CommandException("Class $command.javaClass.name needs to have @Command!")
        }

        // Gets the command annotation value.
        val commandName: String = commandClass.getAnnotation(me.katsumag.aspigotframework.testcommands.annotations.Command::class.java).name
